...
const searchJobs = () => {
  emit('search', { title: searchTitle.value, location: searchLocation.value });
};
            ...
            <div>
                <div
                    ...
                    <div class="flex-1 flex items-center border-r">
                        ...
                        <input placeholder="Job title or keyword" v-model="searchTitle"
                    ...
                    <div class="flex-1 flex items-center">
                        ...
                        <input placeholder="Location" v-model="searchLocation"
                            class="py-4 shadow-none border-none focus:outline-none focus:ring-0 outline-none ring-0"
                            type="text">
                    </div>
                    <button class="bg-brand px-6 text-sm font-medium py-2 rounded-full text-white mr-3" @click="searchJobs">Find
                        jobs</button>
                </div>
            </div>
        </div>
