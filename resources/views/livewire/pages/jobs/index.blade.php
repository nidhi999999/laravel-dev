                            ...
                            @foreach ($jobs as $job)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <img src="{{ $job->company_logo ? Storage::url($job->company_logo) : url('/logo-3.svg') }}" class="h-12 w-auto block mx-auto" alt="{{ $job['company_name'] }}">
                                    </td>
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <a href="#" class="text-sm px-3 py-1.5 rounded hover:bg-slate-100 transition-colors text-red-500" wire:click="deleteJob({{ $job->id }})" >Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
